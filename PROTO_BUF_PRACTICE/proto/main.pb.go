...
func (x *UserProrile) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserProrile) ProtoMessage() {}

func (x *UserProrile) ProtoReflect() protoreflect.Message {
	mi := &file_proto_main_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserProrile.ProtoReflect.Descriptor instead.
func (*UserProrile) Descriptor() ([]byte, []int) {
	return file_proto_main_proto_rawDescGZIP(), []int{2}
}

func (x *UserProrile) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
func (x *UserProrile) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
const file_proto_main_proto_rawDesc = "" +
	...
	"\vUserProrile\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email2>\n" +
	"\aGreeter\x123\n" +
	"\bSayHello\x12\x12.main.HelloRequest\x1a\x13.main.HelloResponseB\x1bZ\x19./proto;mainwithservicepbb\x06proto3"
...
var file_proto_main_proto_goTypes = []any{
	...
	(*UserProrile)(nil),   // 2: main.UserProrile
}
